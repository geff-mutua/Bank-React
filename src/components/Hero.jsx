...
const Hero = () => (
  <section id='home' className={`flex md:flex-row flex-col ${styles.paddingX}`}>
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      py-[16px] px-4 bg-discount-gradient rounded-[10px] mb-2'>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
        Our team of experts uses a methodology to identify the client cards
        most likely to fit your needs.We examine annual percentage rates, annual rates
      </p>
    ...
    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
      ...
      <div className="absolute z-[0] w-[100%] h-[35%] top-0 pink__gradient" />
